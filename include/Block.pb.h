...
PROTOBUF_NAMESPACE_OPEN
template <>
::voxblox::BlockProto* Arena::CreateMaybeMessage<::voxblox::BlockProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class BlockProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>& voxel_data() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>* mutable_voxel_data();

  private:
  ::uint32_t _internal_voxel_data(int index) const;
  void _internal_add_voxel_data(::uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>& _internal_voxel_data() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>* _internal_mutable_voxel_data();
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>& BlockProto::voxel_data() const {
  // @@protoc_insertion_point(field_list:voxblox.BlockProto.voxel_data)
  return _internal_voxel_data();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>* BlockProto::mutable_voxel_data() {
...
inline void BlockProto::_internal_add_voxel_data(::uint32_t value) { _impl_.voxel_data_.Add(value); }
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>& BlockProto::_internal_voxel_data() const {
  return _impl_.voxel_data_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>* BlockProto::_internal_mutable_voxel_data() {
  return &_impl_.voxel_data_;
}
